...
paste0("The intuition was facebook but the variable at the root of the tree is LinkedIn")
```
...
paste0("There are 7 total nodes")
```
...
cm1
paste0("The Accuracy remains 0.9194 but the prediction values in confusion matrix changed")
...
cm2
paste0("The accuracy changes from 0.9194 to 0.9147")
```
