...
(4 points) Load the addresses. You will need to create a vector listing the party affliation of each president to match their speech, you may use the le party.txt to help with this classification.
