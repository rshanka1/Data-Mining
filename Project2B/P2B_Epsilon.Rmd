...
curl <- "curl 'https://api.propublica.org/congress/v1/95/senate/sessions/1/votes/17.json' -H 'X-API-Key:tq0HvAFRpeUYjJRXiEOS70mGhSgG8D44kKicsBv1'"

my_ip <- straighten(curl) %>% make_req()

response <- content(my_ip[[1]](), as="parsed")
response$results$votes
>>>>>>> 2a18acf83e20cf09f0b74a9247830db55a48a494
```
