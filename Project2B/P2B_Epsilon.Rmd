...
#rollcall(data = H114,yea = c(1,2,3),nay = c(4,5,6),missing = c(7,8,9),notInLegis = 0,legis.data = H114$legis.data,vote.data = H114$vote.data,desc = H114$desc,source = H114$source)
